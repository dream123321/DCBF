#
# PLUMED-enabled LAMMPS templates for DCBF sampling.
# This file is intended to be copied or renamed as init/lmp_in.py
# together with an init/input.plumed.tmpl file.
#
